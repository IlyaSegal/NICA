...
void plot() //Результаты фитирования множественности с ратио и классами центральности для Глаубера
{
  // gROOT->SetStyle("Pub");
  gROOT->ForceStyle();
  // gStyle->SetErrorX(0);
...
//  ptB->AddText("N_{hits} > 16, w/o DCA cut");
  ...
  TH2F *hBvsRefMultFit = (TH2F *)fileFitGl->Get("B_VS_Multiplicity_Histo");
  TH2F *hBvsRefMult = (TH2F *)fileIn->Get("reco_vs_sim_info/hMBcorr");
